...
// @xavier: we only change one line. Tagged as "@xavier"
 ...
 */
export class CustomModel implements Completer.IModel {
  /**
  ...
  private _markup(query: string): {
    ...
    for (const originalItem of items) {
      ...
      // @TODO: @xavier: Not filter anything
      results.push({
        item: originalItem,
    ...
    // @xavier: We don't sort completion items.
